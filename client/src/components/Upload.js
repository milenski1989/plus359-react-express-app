...
const Upload = () => {
    ...
    const getArtists = async () => {
        const res = await fetch(`https://plus359-react-express-lk1cf594n-milenski1989s-projects.vercel.app/artists/relatedToEntries`)
    ...
    const handleSubmit = async () => {
        try {
            ...
            await axios.post("https://plus359-react-express-lk1cf594n-milenski1989s-projects.vercel.app/s3/upload", data, {
                headers: {
