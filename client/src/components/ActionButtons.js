...
const ActionButtons = ({art, handleDialogOpen, searchResults, handleSearchResults, className = '', setIsLocationChangeDialogOpen}) => {
    ...
    const updateEntry = async (id) => {
        const response = await axios.put(
            `https://features.ddq4m4fgykx7y.amplifyapp.com/artworks/updateOne/${id}`,
            updatedEntry
        );
    ...
    const handleSubmit = async () => {
        try {
            ...
            const res = await axios.post("https://features.ddq4m4fgykx7y.amplifyapp.com/s3/replace", data, {
                headers: {
