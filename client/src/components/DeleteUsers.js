...
function DeleteUsers() {
    ...
    const deleteUsers = async (users) => {
        ...
        setIsLoading(true);
        try {
            await axios.delete(`https://features.ddq4m4fgykx7y.amplifyapp.com/auth/deleteUsers`, {
                params: { emails },
            });
    ...
    const getUsers = async () => {
        setIsLoading(true);
        try {
            const res = await fetch(`https://features.ddq4m4fgykx7y.amplifyapp.com/auth/all`);
