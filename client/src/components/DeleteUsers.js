...
function DeleteUsers() {
    ...
    const deleteUsers = async (users) => {
        ...
        setIsLoading(true);
        try {
            await axios.delete(`https://plus359-react-express-lk1cf594n-milenski1989s-projects.vercel.app/auth/deleteUsers`, {
                params: { emails },
            });
    ...
    const getUsers = async () => {
        setIsLoading(true);
        try {
            const res = await fetch(`https://plus359-react-express-lk1cf594n-milenski1989s-projects.vercel.app/auth/all`);
